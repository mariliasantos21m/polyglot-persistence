from db_mongo import getMongoConnection 
...
docs = [
    {
        ...
        "category":"hospital",
        "properties":{"city":"São Paulo","rating":4.7},
    ...
    },
    {
        ...
        "category":"academia",
        "properties":{"city":"São Paulo","24h":True},
        "geometry":{"type":"Point","coordinates":[-46.6345,-23.5489]}
    }
]

collection.insert_many(docs)
print(f"Seed ok: {collection.count_documents({})} documentos.")